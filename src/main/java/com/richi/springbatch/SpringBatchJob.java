...
public class SpringBatchJob {
	...
	/** El método performJob será llamado por el programador periódicamente. 
	 * En cada ejecución, comprobamos un directorio de entrada para los archivos de entrada. 
	 * 
	 * Si los archivos están presentes, 
	 * creamos un mapa que contiene el nombre del archivo real más una fecha (para hacerlo único entre los parámetros del trabajo), 
